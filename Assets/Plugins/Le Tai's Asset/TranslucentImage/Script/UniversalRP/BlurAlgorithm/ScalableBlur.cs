...
public class ScalableBlur : IBlurAlgorithm
{
                     ...
                     RenderTexture          target)
    {
        ...
        cmd.BlitProcedural(src, firstIRT, Material, CROP_BLUR_PASS);
        ...
        cmd.BlitProcedural(ShaderId.intermediateRT[stepCount - 1],
                           target,
                           Material,
                           BLUR_PASS);
    ...
    protected virtual void BlurAtDepth(CommandBuffer cmd, int depth, RenderTexture baseTexture)
    {
        ...
        cmd.BlitProcedural(ShaderId.intermediateRT[depth - 1],
